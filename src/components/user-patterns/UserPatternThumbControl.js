...
export default class EffectThumbControl extends Component {
    ...
    componentDidMount () {
        console.log('userPatternThumbControl::componentDidMount()');
        ...
        this.thumbBackground.addClass(styles.userPatternThumb)
    ...
    render () {
        ...
        console.log('thumbControl::render()', this.props.needsSaving, saveStyles);
        return (
